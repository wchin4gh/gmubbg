...
{
    [NotMapped]
    public class ITInvestmentCSVModel
    {
        [Display(Name = "Id")]
        ...
        public ITInvestmentCSVModel ()
        {

        }

        public ITInvestmentCSVModel (ITInvestment purchaseOrder)
        {
        ...
        public ITInvestment ToNewPurchaseOrder()
        {
            ITInvestment purchaseOrder = new ITInvestment()
            {
                Id = this.Id,
        ...
        public ITInvestment UpdatePurchaseOrder(ITInvestment order)
        {
        ...
        public class PurchaseOrderCSVMap : ClassMap<ITInvestmentCSVModel>
        {
